...
public class HelloTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TeacherData.OnEditClickListener onEditClickListener = new TeacherData.OnEditClickListener() {
            ...
            public void onEditClick(TeacherData teacherData) {
                ...
                Toast.makeText(HelloTeacherActivity.this, "Edit Clicked for " + teacherData.getNom(), Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void logout() {
        auth.signOut();
        startActivity(new Intent(HelloTeacherActivity.this, MainActivity.class));
        finish();
    }
    ...
    private void retrieveTeacherData(final TeacherData.OnEditClickListener onEditClickListener) {
        ...
        databaseReference.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(HelloTeacherActivity.this, "Failed to retrieve data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
